...
export function GameLevel({ onEndTurn, onBackToMenu, onShowTutorial, difficulty }: GameLevelProps) {
  ...
  return (
    <div className="relative w-full h-full bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 overflow-hidden">
      ...
      {/* Phone screen cards */}
      <div className={`absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-slate-950 via-slate-900/95 to-transparent pt-10 transition-opacity duration-700 ${playerHealth === 0 || enemyHealth === 0 ? 'opacity-50 pointer-events-none' : 'opacity-100'}`}>
